...
import com.github.danielwegener.logback.kafka.encoding.LogstashKafkaMessageEncoder;
...
public class KafkaAppender<E> extends KafkaAppenderConfig<E> {
    ...
    public KafkaAppender() {
        ...
        setEncoder(new LogstashKafkaMessageEncoder<E>());
        addProducerConfigValue(ProducerConfig.BUFFER_MEMORY_CONFIG, 64 * 1024 * 1024);
        addProducerConfigValue(ProducerConfig.MAX_REQUEST_SIZE_CONFIG, 5 * 1024 * 1024);
        addProducerConfigValue(ProducerConfig.BATCH_SIZE_CONFIG, 100 * 1024);
        addProducerConfigValue(ProducerConfig.LINGER_MS_CONFIG, 2000);
        addProducerConfigValue(ProducerConfig.MAX_BLOCK_MS_CONFIG, 1000);
        addProducerConfigValue(ProducerConfig.ACKS_CONFIG, "0");
        setTopic("logs");
        setName("kafka appender");
    }
     ...
     *
     * @see <a href=
     *      "https://commons.apache.org/proper/commons-lang/javadocs/api-3.4/org/apache/commons/lang3/concurrent/LazyInitializer.html">
     *      LazyInitializer</a>
     */
